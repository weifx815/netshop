    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_account', models.CharField(db_index=True, max_length=50, verbose_name='登录用户名')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('province', models.CharField(blank=True, max_length=100, null=True, verbose_name='所在省')),
                ('province_code', models.CharField(blank=True, max_length=50, null=True, verbose_name='所在省代码')),
                ('city', models.CharField(blank=True, max_length=100, null=True, verbose_name='所在市')),
                ('city_code', models.CharField(blank=True, max_length=50, null=True, verbose_name='所在市代码')),
                ('phone_number', models.CharField(max_length=12, verbose_name='手机号码')),
                ('identity_card', models.CharField(blank=True, max_length=18, null=True, verbose_name='身份证号')),
                ('address', models.CharField(blank=True, max_length=200, null=True, verbose_name='详细住址')),
                ...
                ('login_frequency', models.SmallIntegerField(default=0, verbose_name='登录次数')),
                ('recent_date', models.DateTimeField(auto_now=True, verbose_name='最近一次登录时间')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('origin', models.CharField(blank=True, max_length=50, null=True, verbose_name='籍贯')),
                ('address', models.CharField(blank=True, max_length=200, null=True, verbose_name='详细住址')),
