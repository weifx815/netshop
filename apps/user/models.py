...
class UserInfo(BaseModel):
    ...
    origin = models.CharField(verbose_name="籍贯", max_length=50)
    address = models.CharField(verbose_name="详细住址", max_length=200)
...
class UserAdminInfo(BaseModel):
    ...
    province = models.CharField(verbose_name="所在省", max_length=100)
    province_code = models.CharField(verbose_name='所在省代码', max_length=50)
    city = models.CharField(verbose_name="所在市", max_length=100)
    city_code = models.CharField(verbose_name="所在市代码", max_length=50)
    phone_number = models.CharField(verbose_name="手机号码", max_length=12)
    identity_card = models.CharField(verbose_name="身份证号", max_length=18)
    address = models.CharField(verbose_name="详细住址", max_length=200)
